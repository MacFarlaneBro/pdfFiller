...
public class IndividualDetails {
	...
	public String getDomiciled() {
		return domiciled;
	}
	public void setDomiciled(String domiciled) {
	...
	public void setTradingAccess(boolean tradingAccess) {
		this.tradingAccess = tradingAccess;
	}
	...
	public String getExisingAcctRefNumber() {
		return exisingAcctRefNumber;
	}
